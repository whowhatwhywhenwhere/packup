...
Deno.test("md5 - returns md5 of the given data", async () => {
  assertEquals(await md5("a"), "0cc175b9c0f1b6a831c399e269772661");
  assertEquals(await md5("b"), "92eb5ffee6ae2fec3ad71c777531578f");
  assertEquals(await md5("c"), "4a8a08f09d37b73795649038408b5f33");
});
